...
xsize = 91              #X-dimension of the output matrix. This should match whatever your intended pipeline assumes.
ysize = 91              #Y-dimension of the output matrix. This should match whatever your intended pipeline assumes.
